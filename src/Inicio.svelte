...
<div class="bloque">
  ...
  <Link to="/mercancias">
    <div class="resumen">
      <span class="opcion">🎁 Mercancías</span>
      <span class="descripcion">
        Operaciones CRUD de mercancias en una BD.
      </span>
    </div>
  </Link>
  ...
  <Link to="/proveedores">
    <div class="resumen">
      <span class="opcion">👥 Proveedores</span>
      <span class="descripcion">
        Operaciones CRUD de proveedores en una BD.
      </span>
    </div>
  </Link>
...
<p>
  <small>
    <b>
      Código fuente en
      <a href="https://github.com/Yaye83/merceriafrontend">
        https://github.com/Yaye83/merceriafrontend
      </a>
    </b>
  </small>
</p>